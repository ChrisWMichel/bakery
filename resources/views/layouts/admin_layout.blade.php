        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse in">
                <ul class="nav" id="side-menu">
                     ...
                     <li>
                         <a href="{{route('admin.index')}}"><i class="fa fa-bars" aria-hidden="true"></i> Incoming Orders</a>
                     </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{url('home')}}">Home</a> {{--{{route('home', 'home')}}--}}
                            </li>
                            <li>
                                <a href="{{url('about')}}">About</a>
                            </li>
                            <li>
                                <a href="{{route('hours.index')}}">Hours</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="{{route('items.index')}}"><i class="fa fa-empire" aria-hidden="true"></i> Items</a> {{--<span class="fa arrow"></span>--}}

                    </li>
                    <li>
                        <a href="{{route('cake_items.index')}}"><i class="fa fa-birthday-cake" aria-hidden="true"></i> Cakes</a> {{--<span class="fa arrow"></span>--}}
